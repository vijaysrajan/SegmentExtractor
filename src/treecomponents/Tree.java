...
public class Tree {
	...
	public void addNodeToChild(DimensionNode child, ValueNode parent) throws Exception {
			...
			if (parent == null) {
				throw new Exception("The parent Value Node is null");
			}
			parent.addDimChild(child);
	}
	
	
	public void traverseDimension( DimensionNode dn, String ancestry) {
	     ...
	     while (listIterator.hasNext()) {
	            ...
	            sb.append("->");
	            traverseValue(vn, sb.toString());
	     } 
	}


	public void traverseValue( ValueNode vn, String ancestry) {
	     ...
	     while (listIterator.hasNext()) {
	            ...
	            sb.append("->");
	            traverseDimension(dn, sb.toString());
