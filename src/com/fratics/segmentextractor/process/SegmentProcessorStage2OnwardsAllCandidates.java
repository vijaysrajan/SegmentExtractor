...
public class SegmentProcessorStage2OnwardsAllCandidates extends ProcessableAllCandidates {

    private String stageFile;
    private int stage;

    public SegmentProcessorStage2OnwardsAllCandidates(Context context, String stageFile, int stage) {
